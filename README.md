...
|--------|----------|---------|---------|---------|
| **1**  | Register User's Info Module | [MLTSystem/src/pages/Register.jsx](MLTSystem/src/pages/Register.jsx) |[Backend/app/controllers/AuthController.js] |User,student,tutor,admin,sesison |
| **2**  | Login Module | [MLTSystem/src/pages/Login.jsx](MLTSystem/src/pages/Login.jsx) | [Backend/app/controllers/AuthController.js] |User,student,tutor,admin,sesison |
| **3**  | Edit User Profile Module | [MLTSystem/src/pages/EditProfile.jsx](MLTSystem/src/pages/EditProfile.jsx) | [Backend/app/controllers/AuthController.js] | User,student,tutor,admin,sesison|
