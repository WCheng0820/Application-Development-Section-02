...
const updateNotificationEnum = async () => {
    ...
    try {
        ...
        console.log('Updating notification type ENUM to include "tutor_approval"...');
        await connection.query(`
            ALTER TABLE notification 
            MODIFY COLUMN type ENUM('message','booking','material','feedback','report','tutor_approval') DEFAULT 'message'
        `);
